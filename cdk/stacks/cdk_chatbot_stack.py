...
class ChatbotStack(Stack):
    """
    Class to create the Chatbot resources, which includes the API Gateway,
    ...
    def import_secrets(self) -> None:
        ...
        self.secret_chatbot = aws_secretsmanager.Secret.from_secret_name_v2(
            self,
            "Secret-Chatbot",
            secret_name=self.app_config["chatbot_secret_name"],
        )
    ...
    def create_dynamodb_table(self):
        ...
        self.dynamodb_table = aws_dynamodb.Table(
            self,
            "DynamoDB-Table",
            table_name=self.app_config["chatbot_table_name"],
        ...
        Tags.of(self.dynamodb_table).add("Name", self.app_config["chatbot_table_name"])
    ...
    def create_rest_api(self):
        ...
        rest_api_name = self.app_config["chatbot_api_gw_name"]
